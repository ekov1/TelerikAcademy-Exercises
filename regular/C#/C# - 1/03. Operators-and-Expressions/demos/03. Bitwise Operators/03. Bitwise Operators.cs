...
namespace _03.Bitwise_Operators
{
    class Bitwise_Operators
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(" 3 | 5 => {0}", a | b);      // 00000000 00000111 = 7
            Console.WriteLine(" 3 & 5 => {0}", a & b);      // 00000000 00000001 = 1
            Console.WriteLine(" 3 ^ 5 => {0}", a ^ b);      // 00000000 00000110 = 6
            Console.WriteLine("~3 & 5 => {0}", ~a & b);     // 00000000 00000100 = 4
